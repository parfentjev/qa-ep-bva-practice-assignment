...
const Implementation8: FC = () => {
  ...
  return (
    <BaseImplementation
      title="Implementation 8"
      answer="ON values -10,000 and 10,000; OFF values -10,001 and 10,001; OUT values -15,000 and 15,000 detect this bug."
...
export default Implementation8
